...
//                 let indicators = templateRow.content.querySelectorAll('.indicators');
//                 indicators[0].textContent = data[i].name.firstName;
//                 indicators[1].textContent = data[i].name.lastName;
//                 indicators[2].lastChild.textContent = data[i].about;
//                 textToEyecolour(data[i].eyecolour, indicators[3].querySelector('.icon'));
//                 let clone = templateRow.content.cloneNode(true);
//                 tableBody.append(clone);
//                 tableBody.lastElementChild.addEventListener('click', onClick_OpenRedactor);
//                 tableBody.lastElementChild.ariaRowIndex = data[i].id;
//            }
//         });
//     },
// );
...
function fillTable(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        indicators[1].textContent = data[i].name.lastName;
        indicators[2].lastChild.textContent = data[i].about;
        textToEyeColor(data[i].eyeColor, indicators[3].querySelector('.icon'));
        let clone = templateRow.content.cloneNode(true);
        tableBody.append(clone);
        tableBody.lastElementChild.addEventListener('click', onClick_OpenRedactor);
        tableBody.lastElementChild.ariaRowIndex = data[i].id;
...
function textToEyeColor(data, color) {
    switch (data) {
        case 'green':
